...
class SeedsBuilder:
    ...
    def build_cashwithdrawal_operation_result(self, card_id: str, account_id: str) -> SeedOperationResult:
        """
    ...
    def build_debit_card_account_result(self, plan: SeedAccountsPlan, user_id: str) -> SeedAccountResult:
        ...
        return SeedAccountResult(
            ...
            cash_withdrawal_operations=[
                self.build_cashwithdrawal_operation_result(card_id=card_id, account_id=account_id)
