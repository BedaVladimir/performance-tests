...
class SeedAccountsPlan(BaseModel):
    ...
    Attributes:
        ...
        virtual_cards (SeedCardsPlan): План по созданию виртуальных карт на счетах.
        ...
        transfer_operations (SeedOperationsPlan): План по созданию операции перевода.
        cash_withdrawal_operations (SeedOperationsPlan): План по созданию операции снятия наличных.
    """
    count: int = 0
